(function () {
    angular.module("multipleSelectModule", []).directive("multipleSelect", ["$rootScope", "$timeout", function ($rootScope, $timeout) {
        return {
            restrict: "AE",
            template: "<div class=\"{{ sole }} _angularjs_multiple_select\">\n" +
                "    <div ng-click=\"showSelectFn($event)\" class=\"{{ sole }} _angularjs_multiple_select_chosen\"\n" +
                "         ng-class=\"{'_angularjs_multiple_select_disabled': disabled}\">\n" +
                "        <span ng-show=\"!checkedListObj.length\" class=\"{{ sole }} _angularjs_multiple_select_chosen_tips\">请选择</span>\n" +
                "        <div ng-show=\"checkedListObj.length\" class=\"{{ sole }} _angularjs_multiple_select_chosen_item\">\n" +
                "            <span class=\"{{ sole }} _angularjs_multiple_select_chosen_item_label _angularjs_multiple_select_text-ellipsis\"\n" +
                "                  title=\"{{checkedListObj[0].multiple_select_label}}\">\n" +
                "                {{ checkedListObj[0].multiple_select_label }}\n" +
                "            </span>\n" +
                "            <i class=\"{{ sole }} _angularjs_multiple_select_chosen_item_del\" ng-click=\"del($event)\"></i>\n" +
                "        </div>\n" +
                "        <div ng-show=\"checkedListObj.length > 1\" class=\"{{ sole }} _angularjs_multiple_select_chosen_item\">\n" +
                "            <span class=\"{{ sole }} _angularjs_multiple_select_chosen_item_label\">\n" +
                "                {{ checkedListObj.length - 1}}+</span>\n" +
                "        </div>\n" +
                "    </div>\n" +
                "\n" +
                "    <div ng-show=\"showSelect\" class=\"{{ sole }} _angularjs_multiple_select_module\">\n" +
                "        <div ng-show=\"showSearch\" class=\"{{ sole }} _angularjs_multiple_select_module_search\">\n" +
                "            <input class=\"{{ sole }} _angularjs_multiple_select_module_search_input\"\n" +
                "                   type=\"text\" ng-model=\"searchStr\" ng-change=\"searchFilter()\"/>\n" +
                "        </div>\n" +
                "        <div class=\"{{ sole }} _angularjs_multiple_select_module_list\">\n" +
                "            <ul class=\"{{ sole }} _angularjs_multiple_select_module_list_ul\">\n" +
                ...
                "                    class=\"{{ sole }} _angularjs_multiple_select_module_list_item\">\n" +
                "                        <span class=\"{{ sole }} _angularjs_multiple_select_module_list_item_label _angularjs_multiple_select_text-ellipsis\"\n" +
